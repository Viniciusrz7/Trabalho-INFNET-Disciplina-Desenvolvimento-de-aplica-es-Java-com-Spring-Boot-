...
public class Lanchonete implements Identificavel {
    ...
    @ElementCollection
    @CollectionTable(
            name="pedido_entrega_ids",
            joinColumns = @JoinColumn(name = "pedido_id")
    )
    @Column(name = "entrega_id")
    private Set<Long> entregaIds = new HashSet<Long>();
...
//    }
    ...
    public void adicionarEntrega(Long entregaId){
        entregaIds.add(entregaId);
    }
...
//    }
    ...
    public Set<Long> getEntregaIds() {
        return entregaIds;
    }

    public void setEntregaIds(Set<Long> entregaIds) {
