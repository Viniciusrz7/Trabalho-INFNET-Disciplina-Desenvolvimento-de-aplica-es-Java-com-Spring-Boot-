...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(EntregaNaoEncontradoException.class)
    public ResponseEntity<ErroResponse> tratarRecursoNaoEncontrado(EntregaNaoEncontradoException exception){
